  ...
  return (
    <div className="feedback-section">
      ...
      <div className="feedback-card-container">
        <div className="feedback-card">
          ...
          <div className="feedback-card-foot">
            <div className="personImg">
              <img src="/image/review/person4.jpg" alt="" />
            </div>
        ...
        <div className="feedback-card">
          <p className="feedback-message">
            It Nova, It's very easy to learn and topics&amp; all courses is
            available what people is trying to learn and budget friendly to
            learn the courses . Thank u It Nova
          </p>
          <div className="feedback-card-foot">
            <div className="personImg">
        ...
        <div className="feedback-card">
          ...
          <div className="feedback-card-foot">
            <div className="personImg">
              <img src="/image/review/person1.jpg" alt="" />
            </div>
            <div className="feedback-profile">
        ...
        <div className="feedback-card">
          <p className="feedback-message">
            Choosing It Nova for my internship was a great decision, as I gained a
            lot of knowledge and learned many new things. The mentors were
            friendly and collaborative, making it a valuable opportunity for my
            future. Thank you, and I'm pleased to be part of this company.
          </p>
          <div className="feedback-card-foot">
            <div className="personImg">
              <img src="/image/review/person3.jpg" alt="" />
            </div>
            <div className="feedback-profile">
        ...
        <div className="feedback-card">
          <p className="feedback-message">
            It Nova is a good option toy internship. I feel very good to join in
            this internship. I have learn more from this It Nova, thank you.
          </p>
          <div className="feedback-card-foot">
            <div className="personImg">
              <img src="/image/review/person6.jpg" alt="" />
            </div>
            <div className="feedback-profile">
        ...
        <div className="feedback-card">
          <p className="feedback-message">
            It Nova is a robust and user-friendly platform for managing tasks,
        ...
        <div className="feedback-card">
          ...
          <div className="feedback-card-foot">
            <div className="personImg">
              <img src="/image/review/person9.jpg" alt="" />
            </div>
            <div className="feedback-profile">
              <h3>Vinay Kumar</h3>
        ...
        <div className="feedback-card">
          ...
          <div className="feedback-card-foot">
            <div className="personImg">
              <img src="/image/review/person8.jpg" alt="" />
            </div>
            <div className="feedback-profile">
              <h3>Sanskriti Roy</h3>
